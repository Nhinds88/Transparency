...
function OrbitCamera(input) {
    ...
    this.getViewMatrix = function() {
        ...
        var world = this.cameraWorldMatrix.clone();
        var view = world.inverse();
        return view;
    }
    ...
    this.getPosition = function() {
        ...
        var x = this.cameraWorldMatrix.elements[3];
        var y = this.cameraWorldMatrix.elements[7];
        var z = this.cameraWorldMatrix.elements[11];
        var position = new Vector3(x, y, z).normalize();
